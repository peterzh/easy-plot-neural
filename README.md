# easy-plot-neural
MATLAB package for easy plotting of neural raster/psths, and event-aligned averages of an arbitrary continuous variable. Add the +easy folder to your MATLAB path and use the following functions (see help documentation for each function):
...
<img src="examples/RasterPSTH.png" width="100%" title="RasterPSTH" alt="RasterPSTH" align="left" vspace = "50">
...
<img src="examples/EventAlignedAverage.png" width="100%" title="EventAlignedAverage" alt="EventAlignedAverage" align="left" vspace = "50">


# easy.PSTHByDepth()
Shows event-aligned spiking activity across an entire electrophysiological probe.
<img src="examples/PSTHbyDepth.png" width="100%" title="PSTHbyDepth" alt="PSTHByDepth" align="left" vspace = "50">
